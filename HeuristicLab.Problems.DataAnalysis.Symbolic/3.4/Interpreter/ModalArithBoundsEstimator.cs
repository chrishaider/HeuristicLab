...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  ...
  public sealed class ModalArithBoundsEstimator : ParameterizedNamedItem, IBoundsEstimator {
    ...
    [StorableConstructor]
    private ModalArithBoundsEstimator(StorableConstructorFlag _) : base(_) { }

    private ModalArithBoundsEstimator(ModalArithBoundsEstimator original, Cloner cloner) : base(original, cloner) { }

    public ModalArithBoundsEstimator() : base("Modal Arithmetic Bounds Estimator",
    ...
    public override IDeepCloneable Clone(Cloner cloner) {
      return new ModalArithBoundsEstimator(this, cloner);
    }
