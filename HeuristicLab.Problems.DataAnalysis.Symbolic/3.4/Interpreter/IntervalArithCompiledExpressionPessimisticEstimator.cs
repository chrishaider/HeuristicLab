...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  ...
  public class IntervalArithCompiledExpressionPessimisticEstimator : ParameterizedNamedItem, IPessimisticEstimator {
    ...
    public IntervalArithCompiledExpressionPessimisticEstimator() : base("Interval Arithmetic Compiled Expression Bounds Estimator",
    ...
    [StorableConstructor]
    protected IntervalArithCompiledExpressionPessimisticEstimator(StorableConstructorFlag _) : base(_) { }

    protected IntervalArithCompiledExpressionPessimisticEstimator(IntervalArithCompiledExpressionPessimisticEstimator original, Cloner cloner) : base(original, cloner) { }

    public override IDeepCloneable Clone(Cloner cloner) {
      return new IntervalArithCompiledExpressionPessimisticEstimator(this, cloner);
    }
