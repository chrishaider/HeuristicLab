...
namespace HeuristicLab.Problems.DataAnalysis.Symbolic {
  ...
  public sealed class IntervalArithPessimisticEstimator : ParameterizedNamedItem, IPessimisticEstimator {
    #region Parameters
    ...
    [StorableConstructor]
    private IntervalArithPessimisticEstimator(StorableConstructorFlag _) : base(_) { }

    protected IntervalArithPessimisticEstimator(IntervalArithPessimisticEstimator original, Cloner cloner) : base(original, cloner) { }

    public IntervalArithPessimisticEstimator() : base("Interval Arithmetic Bounds Estimator",
    ...
    public override IDeepCloneable Clone(Cloner cloner) {
      return new IntervalArithPessimisticEstimator(this, cloner);
    }
